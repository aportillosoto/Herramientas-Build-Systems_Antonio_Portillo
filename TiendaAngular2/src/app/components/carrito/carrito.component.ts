...
export class CarritoComponent implements OnInit {
  ...
  //=============Pagar Carrito==================================================
  pagarCarrito(){
    this.http.get('https://tiendanext-75443.firebaseio.com/productos/.json') //Realizar una consulta a la base de datos
  ...
  actualizarDisponible(id:number, itemCatalogo:Producto){
    return this.http.put(`https://tiendanext-75443.firebaseio.com/productos/${id}.json`, itemCatalogo) //Ejecutar el método put a la url de la base de datos enviando como parámetro el objeto Producto con su nuevos valores disponibles
    .map((response : Response) => {
