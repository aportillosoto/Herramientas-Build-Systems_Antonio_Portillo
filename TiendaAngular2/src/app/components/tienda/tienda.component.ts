...
export class TiendaComponent implements OnInit {
  ...
  constructor(private detectChanges:ChangeDetectorRef,  //Agregar el modelo ChangeDetectorRef para refrescar el renderizado de la página al existir algún cambio en vivo
              private router : Router, //Agregar el módulo Router para manejar las URL de la página
              private tiendaService : TiendaService, //Agregar el servicio TiendaService para interactuar con los items del catálogo de productos
              private auth : AuthService, //Agregar el servicio CarritoService para interactuar con los parámetros de sesión
              private carritoService : CarritoService //Agregar el servicio CarritoService para interactuar con los items del carrito
