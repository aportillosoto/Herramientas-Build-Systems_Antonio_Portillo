...
class Carrito extends React.Component{
  ...
  pagarCarrito(){
    ...
    request
    .get('https://tiendanext-75443.firebaseio.com/productos/.json')                //Realizar una consulta a la base de datos
    .then((res) => {
...
actualizarDB(itemCatalogo, cantidad){
  request.put(`https://tiendanext-75443.firebaseio.com/productos/${itemCatalogo.id}.json`)  //Realizar consulta a base de datos
